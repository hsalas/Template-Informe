...
\def\documentlang {en-US}          % Define el idioma del documento
...
\def\nameappendixsection {Annex}     % Nombre de la sec. de anexos/apéndices
...
\def\nomltappendixsection {Annex}     % Etiqueta sección en anexo/apéndices
\def\nomltcont {Content Index } % Nombre del índice de contenidos
\def\nomltfigure {Figure}Index   % Nombre del índice de lista de figuras
\def\nomltsrc {Code Index}      % Nombre del índice de lista de código
\def\nomlttable {Table Index}     % Nombre del índice de lista de tablas
